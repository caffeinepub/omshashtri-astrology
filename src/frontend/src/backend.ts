...
export class Backend implements backendInterface {
    ...
    async getBirthChartInfo(): Promise<{
        sun: string;
        moon: string;
        rising: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getBirthChartInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyHoroscopes(): Promise<Array<Horoscope>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyHoroscopes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getZodiacSigns(): Promise<Array<ZodiacSign>> {
        if (this.processError) {
            try {
                const result = await this.actor.getZodiacSigns();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
